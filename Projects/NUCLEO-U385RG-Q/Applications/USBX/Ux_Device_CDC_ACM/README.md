...
This application provides an example of Eclipse USBX stack usage on NUCLEO-U385RG-Q board, it shows how to develop USB Device communication Class "CDC_ACM" based application.
...
RTOS, FreeRTOS, USBX Device, USB_DRD, Full Speed, CDC, VCP, USART.
